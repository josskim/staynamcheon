...
<div class="space-y-8 text-gray-800 leading-relaxed max-w-2xl mx-auto my-12 font-sans tracking-wide">
  ...
  <blockquote class="bg-gray-50 border-l-4 border-[#DB5461] p-6 text-lg font-medium text-gray-700 italic rounded-r-xl shadow-sm my-10">
  ...
  try {
    const story = await prisma.stayStory.create({
      data: {
        ...
        content: contentHtml,
        images: "[]", // 사용자님이 직접 편집 페이지에서 이미지 업로드하도록 비워둠
