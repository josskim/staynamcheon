...
export default function CampnicManagementPage() {
  ...
  const handleUpdate = async (section: string, key: string, value: string) => {
    ...
    try {
      await fetch("/api/admin/content", {
        ...
        body: JSON.stringify({ page: "campnic", section, key, value, type: "text" }),
      });
    } catch (err) {
  ...
  if (loading) return <div className="animate-pulse">Loading Campnic Management...</div>;

  return (
    <div className="space-y-12">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold text-[#171212] tracking-tight">Campnic Management</h1>
          <p className="text-[#856669] mt-2 font-medium">Manage the details and imagery for the Outdoor glamping section.</p>
        </div>
        ...
        <section className="bg-white rounded-3xl border border-[#e4dcdd] overflow-hidden">
          ...
          <div className="p-8 space-y-6">
            <div className="space-y-2">
              ...
              <input 
                type="text" 
                defaultValue={content.find(c => c.section === "hero" && c.key === "title")?.value || "Campnic"}
            ...
            <div className="space-y-2">
              ...
              <textarea 
                rows={4}
                defaultValue={content.find(c => c.section === "about" && c.key === "description")?.value || "Where camping meets picnic. Our curated glamping experience."}
        ...
        <section className="bg-white rounded-3xl border border-[#e4dcdd] overflow-hidden">
          ...
          <div className="p-8 space-y-6">
            <div className="space-y-2">
              ...
              <input 
                type="text" 
                defaultValue={content.find(c => c.section === "hero" && c.key === "imageUrl")?.value || "/images/lovable/campnic.jpg"}
