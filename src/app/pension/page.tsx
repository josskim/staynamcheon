...
export const metadata: Metadata = {
  title: "펜션 객실",
  description: "스테이남천의 경산 독채 펜션 객실을 소개합니다. 101호 독채, 201호·202호, 201+202호 전체 대관을 인원에 맞게 선택하세요.",
  alternates: { canonical: "https://www.xn--q20b145avpd59fmvg.com/pension" },
  openGraph: {
    title: "독채·객실 안내 | 스테이남천",
    description: "경산 독채 펜션 스테이남천 객실 안내. 101호, 201호·202호, 전체 대관.",
    images: [{ url: "/images/lovable/pension.jpg", width: 1200, height: 630, alt: "스테이남천 독채 펜션 객실" }],
  },
};
